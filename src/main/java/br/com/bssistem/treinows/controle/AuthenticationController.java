...
public class AuthenticationController extends
	...
	@ResponseBody
	public void auth(@PathVariable("id") String identificador) {
		
		try {
			exchangeCode("601276251172-inhd3j43ncehh6vaevde7t0ef8cmm44a.apps.googleusercontent.com");
	  ...
	  private static final String APPLICATION_NAME = "treinoWS";
	...
	/**
	  ...
	  static GoogleAuthorizationCodeFlow getFlow() throws IOException {
	    if (flow == null) {
	      InputStream in =
	    		  AuthenticationController.class.getResourceAsStream(CLIENTSECRET_LOCATION);
